...
const VALUE_WORDS = [
  "성장","자유","안정","연결","정직","창의","도전","평온","인정","기여",
  "배움","건강","가족","우정","성취","균형","모험","아름다움","진정성","영향력",
  "독립","유머","호기심","신뢰","책임","열정","감사","용기","친절","지혜",
  "자율","전문성","풍요","소속","질서","변화","휴식","표현","공정","사랑",
  "끈기","낙관","절제","몰입","효율","명료","깊이","다양성","전통","혁신",
  "봉사","성실","여유","자부심","개방","집중","섬세함","대담함","조화","진실"
];
...
const COURSE = {
    ...
    },
    {
      ...
      steps: [
        { type: "intro", title: "나를 움직이는 가치와 강점",
          body: "마음이 가는 단어를 천천히 좁혀가며 지금의 나를 관통하는 가치를 찾아봐요. 서두르지 않아도 괜찮아요." },
        { type: "cardFilter", id: "w3_values", title: "나의 가치 단어",
          words: VALUE_WORDS,
          stage1Hint: "1단계 · 마음이 가는 단어를 골라보세요 (12개 안팎 권장)",
          stage2Hint: "2단계 · 그중 정말 나를 담은 다섯 개만 남겨요",
          stage1Target: 12, stage2Target: 5 },
    ...
    },
    {
      ...
      steps: [
        { type: "intro", title: "지금의 나를 지도로",
          body: "평가가 아니라 현재 위치예요. 점수가 낮은 영역이 나쁜 게 아니라, 지금 거기 있다는 뜻일 뿐이에요." },
        { type: "sliders", id: "w4_areas", title: "지금 내 삶의 영역들 (0~10)",
          hint: "직감으로 슬라이더를 옮겨요. 옮기면 아래 그림이 함께 변해요.",
          items: ["돈","건강","일","마음","관계","일상","배움","놀이"] },
        { type: "text", id: "w4_area_note", multiline: true, title: "각 영역, 지금 한 줄씩", hint: "마음 가는 영역만 적어도 돼요." },
  ...
  locked: [
    { badge: "2달차", title: "내가 원하는 걸 찾는다", desc: "마음·관계·일·궁극의 질문 — 곧 열려요" },
    { badge: "3달차", title: "파고들어 책으로", desc: "비전·확언·실험 그리고 완성 — 곧 열려요" }
  ]
};
