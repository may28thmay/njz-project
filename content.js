...
/* 강점이 지나칠 때 나오는 '그림자' — 강점 카드(w3_strengths.words) 40개와 1:1.
 * 화면엔 일상어만. 심리 용어 금지. w3_shadow_pick(shadow 컴포넌트)가 참조한다. */
const SHADOW_MAP = {
  "호기심": ["금세 싫증", "산만해짐"], "배움": ["실행보다 공부만"], "통찰": ["생각만 많아짐"],
  "분석력": ["과분석·결정 지연"], "창의성": ["마무리 약함"], "전략적사고": ["행동이 늦음"],
  "신중함": ["우유부단·결정 미룸"], "큰그림": ["디테일 놓침"],
  "추진력": ["너무 밀어붙임"], "끈기": ["손절 못함"], "책임감": ["다 떠안음"],
  "성실함": ["융통성 부족"], "집중력": ["주변을 못 봄"], "정리정돈": ["과한 통제"],
  "마무리": ["완벽 집착", "디테일 집착"], "회복탄력": ["내 상처를 가벼이 봄"],
  "공감": ["다 떠안음", "감정 소진"], "경청": ["내 말은 못 함"], "배려": ["거절 못함"],
  "친화력": ["미움받기 싫어 맞춤"], "화합": ["갈등 회피"], "신뢰주기": ["쉽게 실망"],
  "가르치기": ["가르치려 듦"], "돌봄": ["선 넘는 참견"],
  "주도성": ["독단적"], "결단력": ["성급함"], "자신감": ["과신·오만"],
  "동기부여": ["오지랖·강요"], "표현력": ["말이 앞섬"], "설득": ["밀어붙이는 인상"],
  "용기": ["무모함"], "비전": ["현실 외면"],
  "긍정": ["문제 외면"], "유머": ["진지함 회피"], "감사": ["불만을 못 냄"],
  "진정성": ["너무 직설적"], "겸손": ["자기를 낮춤"], "차분함": ["미적지근해 보임"],
  "열정": ["쉽게 소진"], "공정함": ["융통성 없음"]
};
