...
const COURSE = {
    ...
    },
    {
      ...
      meetup: {
        discuss: [
          ...
          "(조하리 창) 친구가 써준 단어 중, 내가 전혀 몰랐던 나의 강점은?"
        ],
        activity: [
    ...
    },
    {
      ...
      steps: [
        { type: "intro", title: "지금의 나를 지도로",
          body: "「나를 알아가는 68가지 질문」 중 '지금의 나' 부분을 지도로 그려봐요. 평가가 아니라 현재 위치예요. 점수가 낮은 영역이 나쁜 게 아니라, 지금 거기 있다는 뜻일 뿐이에요." },
        { type: "sliders", id: "w4_areas", title: "지금 내 삶의 영역들 (0~10)",
          hint: "직감으로 슬라이더를 옮겨요. 옮기면 아래 그림이 함께 변해요. (인생수레바퀴)",
          items: ["돈","건강","일","마음","관계","일상","배움","놀이"] },
        { type: "text", id: "w4_area_note", multiline: true, title: "각 영역, 지금 한 줄씩",
          hint: "돈·건강·일·마음·관계·일상·배움·놀이 — 마음 가는 영역에 '지금 어떤지' 한 줄씩. (「나를 알아가는 68가지 질문」의 현재편이에요.)" },
  ...
  locked: [
    { badge: "2달차", title: "내가 원하는 걸 찾는다", desc: "이키가이·오디세이 플랜·68질문 목표편 — 곧 열려요" },
    { badge: "3달차", title: "파고들어 책으로", desc: "두려움 설정·비전·실험 그리고 완성 — 곧 열려요" }
  ]
};
