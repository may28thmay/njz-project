  ...
  weeks: [
    ...
    },
    {
      ...
      steps: [
        ...
        { type: "choices", id: "w3_weak", multi: true, max: 5, allowOther: true, title: "내가 보완하고 싶은 약한 부분 (5개)",
          hint: "약점은 흠이 아니에요 — 알면 강점으로 덮거나 비껴갈 수 있어요. 가장 걸리는 5개만.",
          options: ["미루기","산만함","우유부단","욱함","완벽주의","과민함","걱정많음","회피",
            "고집","자기비판","거절 못함","감정기복","비교하기","소심함","독선","의존",
            "무계획","끈기부족","표현부족","경계 없음","디테일 약함","즉흥과다","낯가림","뒷심부족",
            "질투","쉽게 지침","눈치과다","결정 미루기"] },
        { type: "list", id: "w3_evidence", optional: true, title: "그 강점이 '실제로' 드러난 순간",
          hint: "여유 있으면 강점마다 한 줄씩. 추상적인 단어를 내 실제 경험에 붙이는 단계예요.", rows: 3, addable: true, placeholder: "예: 회의에서 큰그림을 정리해줬을 때" },
